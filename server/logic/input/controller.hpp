...
#include "../rules/castling_rules.hpp"
...
public:
    ...
    static std::vector<Motion> handleClick(int row, int col, GameState& gameState, char actingColor);
...
private:
    ...
    static std::vector<Motion> handleClickWithSelection(const Position& clicked, const Position& selected, GameState& gameState, char actingColor);
};
